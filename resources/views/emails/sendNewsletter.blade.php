...
<div class="es-wrapper-color" style="background-color:#E5CEA7;">
    <!--[if gte mso 9]>
                    ...
                    <tr style="border-collapse:collapse;">
                        <td class="es-adaptive" align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body"
                                   style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#99C355;"
                                   width="600" cellspacing="0" cellpadding="0" bgcolor="#99c355" align="center">
                                <tr style="border-collapse:collapse;">
                                    <td align="left"
                    ...
                    <tr style="border-collapse:collapse;">
                        <td align="center" style="padding:0;Margin:0;">
                            <table class="es-content-body"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td style="Margin:0;padding-top:5px;padding-left:30px;padding-right:30px;padding-bottom:40px;background-repeat:repeat;background-color:#468E24;"
                                        bgcolor="#468e24" align="left">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                            ...
                            <table class="es-footer-body"
                                ...
                                <tr style="border-collapse:collapse;">
                                    <td align="left" bgcolor="transparent"
                                        style="Margin:0;padding-left:10px;padding-right:10px;padding-top:15px;padding-bottom:20px;background-color:transparent;">
                                        <table width="100%" cellspacing="0" cellpadding="0"
                                               style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                                            <tr style="border-collapse:collapse;">
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center" style="padding:0;Margin:0;"><p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:13px;font-family:'trebuchet ms', 'lucida grande', 'lucida sans unicode', 'lucida sans', tahoma, sans-serif;line-height:20px;color:#333333;">
                                                                    Aluthads.lk© 2019&nbsp;All rights reserved</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center"
                                                                ...
                                                                <table class="es-table-not-adapt es-social"
                                                                    ...
                                                                    <tr style="border-collapse:collapse;">
                                                                        <td valign="top" align="center"
                                                                            ...
                                                                            <img title="Twitter"
                                                                                 src="https://piotr.stripocdn.email/content/assets/img/social-icons/circle-black/twitter-circle-black.png"
                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            style="padding:0;Margin:0;padding-right:10px;">
                                                                            <img title="Facebook"
                                                                                 src="https://piotr.stripocdn.email/content/assets/img/social-icons/circle-black/facebook-circle-black.png"
                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            style="padding:0;Margin:0;padding-right:10px;">
                                                                            <img title="Youtube"
                                                                                 src="https://piotr.stripocdn.email/content/assets/img/social-icons/circle-black/youtube-circle-black.png"
                                                                        ...
                                                                        <td valign="top" align="center"
                                                                            style="padding:0;Margin:0;"><img
                                                                                    title="Vkontakte"
                                                                                    src="https://piotr.stripocdn.email/content/assets/img/social-icons/circle-black/vk-circle-black.png"
                                                                                    alt="Vk" width="32" height="32"
                                                                                    style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;">
                                                                        </td>
                                                                    </tr>
                                                                </table>

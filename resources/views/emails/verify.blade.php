            ...
            {{--<table cellpadding="0" width="620" class="container" align="center" cellspacing="0" border="0">--}}
                {{--<tr>--}}
                    {{--<td>--}}
                        ...
                        {{--<table cellpadding="0" cellspacing="0" border="0" align="center" width="600" class="container" style="background-color: white">--}}
                            {{--<tr>--}}
                                            ...
                                            {{--<tr>--}}
                                                ...
                                                {{--<td width="200" valign="top" align="center">--}}
                                                    {{--<div class="contentEditableContainer contentImageEditable">--}}
                                                        {{--<div class="contentEditable" align='center' style="background-color: #139e81;width: 400px;height: 100px">--}}
                                                            {{--<br>--}}
                                                            {{--<br>--}}
                                                ...
                                                {{--<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">--}}
                                                    {{--<div class="contentEditableContainer contentTextEditable">--}}
                                                        {{--<div class="contentEditable" align='left' >--}}
                                                            {{--<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;margin-left: 100px">TextCopyrights @ aluthads.lk.</span>--}}
                                            ...
                                            <tr style="border-collapse:collapse;">
                                                <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#FFFFFF;border-radius:4px;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                        <tr style="border-collapse:collapse;">
                                                            <td align="center" style="Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px;"> <h1 style="Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:48px;font-style:normal;font-weight:normal;color:#111111;">Hello {{ $user }},</h1> </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse;">

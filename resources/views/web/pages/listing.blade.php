                                ...
                                <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-12">
                                    <div class="product-box item-mb zoom-gallery">
                                        ...
                                        ->category_id]['slug']).'/'.$advertisement->slug}}">
                                                    <img src="{{env('APP_URL').'images/advertisements/'.$advertisement->img_1}}"
                                                    ...
                                                    <div class="symbol-featured {{ $advertisement->is_featured ? 'active' : '' }}"><img src="{{asset('web/img/banner/symbol-featured.png')}}" alt="symbol" class="img-fluid"> </div>
                                            ...
                                            <div class="item-desc-wrapper">
                                                ...
                                                <div class="item-pirce text-center">
                                                    {{$advertisement->price ? 'Rs '.number_format($advertisement->price).' (Fixed)' :  'Negotiable'}}
                                                </div>
                                                <div class="item-views-date">
                                                    <div class="item-date text-center">
                                                        {{ucwords(trans($advertisement->updated_at->diffForHumans()))}}
                                                    </div>
                                                    <div class="item-views text-center">
                                                        <span class="fa fa-eye"></span> {{$advertisement->views}}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
